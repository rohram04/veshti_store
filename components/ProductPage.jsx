import products, { useProducts } from "../hooks/products";
import useCart from "../hooks/cart";
import { useRouter } from "next/router";
import Loader from "./loader";
import useSWR from "swr";
import { useDispatch } from "react-redux";
import { increment } from "../hooks/cart";
...
export default function ProductPage({ increase }) {
        ...
        <div className="mt-6 max-w-2xl mx-auto sm:px-6 lg:max-w-7xl lg:px-8 lg:gap-x-8">
          <div className="hidden aspect-w-3 aspect-h-4 rounded-lg overflow-hidden lg:block">
            <img
              ...
              className="h-full object-center object-contain max-h-96 rounded w-full"
            />
          </div>
